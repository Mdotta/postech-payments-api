...
#   ECR_REPO        - ECR repository name (default: tf-postech-postech-payments-api)
#   IMAGE_TAG       - Image tag (default: latest)
# =============================================================================

AWS_ACCOUNT_ID="${AWS_ACCOUNT_ID:?❌ AWS_ACCOUNT_ID is not set}"
AWS_REGION="${AWS_REGION:-us-east-1}"
ECR_REPO="${ECR_REPO:-tf-postech-postech-payments-api}"
...
echo ""
echo "📋 Redeploy EC2 next via Terraform:"
echo "   cd postech-orchestration/terraform/envs/prod"
echo "   terraform apply -target=module.ecr"
echo "   terraform apply -target=module.payments_service"
